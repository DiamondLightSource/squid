...
const SampleParametersForm = () => {
    ...
    const removeMotorPosition = (index) => {
        setFormData({
            ...formData,
            sampleParameterMotorPosition: formData.sampleParameterMotorPosition.filter(
                (_, idx) => idx !== index
            ),
        });
    };
        ...
        >
            ...
            <label>
                ...
                <input
                    ...
                    onChange={(e) => handleUpdateField(["shouldValidate"], e.target.checked)}
                />
            </label>
            <label>
                Name:
            ...
            <label>
                ...
                <input
                    ...
                    onChange={(e) => handleUpdateField(["temperaturecontrol"], e.target.value)}
                    required
                />
            </label>
            ...
            <label>
                ...
                <input
                    ...
                    onChange={(e) =>
                        handleUpdateField(["xythetastage", "theta"], parseFloat(e.target.value))
                    }
                />
            </label>
            ...
            {formData.sampleParameterMotorPosition.map((motor, index) => (
                <div key={index} style={{ border: "1px solid #ccc", marginBottom: "1rem" }}>
                    <label>
                        Scannable Name:
                        <input
                            type="text"
                            ...
                            onChange={(e) =>
                                handleMotorPositionChange(index, "scannableName", e.target.value)
                            }
                        />
                    </label>
                    <label>
                    ...
                    <label>
                        ...
                        <input
                            ...
                            onChange={(e) =>
                                handleMotorPositionChange(index, "demandPosition", parseFloat(e.target.value))
                            }
                        />
                    </label>
